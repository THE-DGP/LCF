...
st.markdown('Laxmi Chit Fund', unsafe_allow_html=True)
option = st.sidebar.selectbox('Select one symbol', ( 'ITC.NS', 'MRF.NS',"BAJAJ-AUTO.NS",'BRITANNIA.NS', 'LTIM.NS', 'RELIANCE.NS', 
                                                    'TCS.NS', 'HINDALCO.NS', 'MARUTI.NS', 'TITAN.NS', 'NTPC.NS', 'WIPRO.NS'))
